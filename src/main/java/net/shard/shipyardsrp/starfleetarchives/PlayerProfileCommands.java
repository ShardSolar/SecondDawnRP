...
public class PlayerProfileCommands {
        ...
        dispatcher.register(CommandManager.literal("profile")
                ...
                .then(CommandManager.literal("view")
                        .executes(context -> {
                            ...
                            PlayerProfile profile = ShipyardsRP.PROFILE_SERVICE.getOrLoad(player);
                ...
                .then(CommandManager.literal("setdivision")
                        .then(CommandManager.argument("division", StringArgumentType.word())
                                .executes(context -> {
                                    ...
                                    ShipyardsRP.PROFILE_SERVICE.setDivision(player, division);
                ...
                .then(CommandManager.literal("setrank")
                        .then(CommandManager.argument("rank", StringArgumentType.word())
                                .executes(context -> {
                                    ...
                                    ShipyardsRP.PROFILE_SERVICE.setRank(player, rank);
                ...
                .then(CommandManager.literal("addbillet")
                        .then(CommandManager.argument("billet", StringArgumentType.word())
                                .executes(context -> {
                                    ...
                                    ShipyardsRP.PROFILE_SERVICE.addBillet(player, billet);
                ...
                .then(CommandManager.literal("removebillet")
                        .then(CommandManager.argument("billet", StringArgumentType.word())
                                .executes(context -> {
                                    ...
                                    ShipyardsRP.PROFILE_SERVICE.removeBillet(player, billet);
                ...
                .then(CommandManager.literal("addpoints")
                        .then(CommandManager.argument("amount", IntegerArgumentType.integer())
                                .executes(context -> {
                                    ...
                                    ShipyardsRP.PROFILE_SERVICE.addRankPoints(player, amount);
    ...
    private static void ensureReady() {
        if (ShipyardsRP.PROFILE_SERVICE == null) {
            throw new IllegalStateException("ShipyardsRP profile services are not initialized yet.");
        }
    }
}